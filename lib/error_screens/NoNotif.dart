  ...
  child:Column(children: [
            ...
            Center(
               ...
               Padding(
                 ...
                 child: Image.asset("assets/images/NoNotif.png",width: 300,height: 300,),
               ),),
               Text("No Notifications Yet",style:TextStyle(color:bluee,fontSize: 23,fontWeight: FontWeight.bold)),
               Padding(
                 padding: const EdgeInsets.only(top:6.0),
                 child: Text("When you get notifications, they’ll\n                  show up here.",style:TextStyle(color:gray,fontSize: 20,fontWeight: FontWeight.w500)),
               ),
               Padding(
